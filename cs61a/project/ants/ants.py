...
#            self.entrance = exit
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.ant.is_container == True and insect.is_container == False and self.ant.can_contain(insect):
                    #if self.ant.can_contain(insect):
                        self.ant.contain_ant(insect)
                elif insect.is_container == True and self.ant.is_container == False and insect.can_contain(self.ant):
                    #if insect.can_contain(self.ant):
                        insect.contain_ant(self.ant)
                        self.ant = insect
                else:
                    assert self.ant.can_contain(insect) != None , 'Two ants in {0}'.format(self)
                # END Problem 9
        else:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and insect.is_Truequeen == True:
                return None
            # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        area = self.place
        if self.place.ant and area.ant.blocks_path :
            return True
        else:
            return False
        # END Problem 7
...
#    is_container = False
    ...
    def nearest_bee(self, hive):
        ...
        while i < self.min_range:
            area = area.entrance
            i +=1
        while not area.bees and area != hive:
            area = area.entrance
            i += 1
        if i > self.max_range or area == hive:
            return None
        return random_or_none(area.bees)
        # END Problem 3 and 4
...
#            Ant.action(self.contained_ant, colony)
        # END Problem 9
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_Truequeen == False:
            ...
            while place:
                if place.ant:
                    if isinstance(place.ant, BodyguardAnt) and place.ant.contained_ant and place.ant.contained_ant not in self.damages_double:
                        place.ant.contained_ant.damage *=2
                        self.damages_double.append(place.ant.contained_ant)
                    if place.ant not in self.damages_double:
                        place.ant.damage *=2
                        self.damages_double.append(place.ant)
                place =place.exit
